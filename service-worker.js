...
const CACHE='financial-lab-v4.1.6.1';
const CORE=['./styles.css?v=4.1.6.1','./app.js?v=4.1.6.1','./manifest.webmanifest','./icon-192.png','./icon-512.png','./financial-lab-logo.jpg','./dexx-character-clean.jpg'];
