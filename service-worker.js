...
const CACHE='financial-lab-v4.1.6';
const CORE=['./styles.css?v=4.1.6','./app.js?v=4.1.6','./manifest.webmanifest','./icon-192.png','./icon-512.png','./financial-lab-logo.jpg','./dexx-character-clean.jpg'];
